  ...
  return (
    <div className="animate-fade-in-up space-y-12 pb-20 font-arabic">
      ...
      <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-[#16161a] to-[#0c0c0e] border border-white/5 p-8 md:p-16 text-center">
        ...
        <div className="relative inline-flex items-center justify-center w-24 h-24 rounded-[2.5rem] bg-primary mb-8 shadow-2xl shadow-primary/20">
        ...
        <h1 className="relative text-4xl md:text-5xl font-black text-white mb-6 tracking-tight leading-tight">
          ...
          <span className="block text-primary mt-2 text-2xl md:text-3xl font-bold">تميز.. إبداع.. وتفوق</span>
        </h1>
        {isAdmin && (
